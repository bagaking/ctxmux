...
Generated declarations provide static parity. The SDK separately validates full
generation-14 frames at runtime, decodes strict base64 output chunks to
`Uint8Array`, and rejects unsafe integer cursors. Protocol compatibility policy
...
- Does a future replacement for generation 14 need generated runtime validation
