...
| Chaos, security, and resources                   | Named process kills, malformed/oversized/long-lived frames, argv/env/secret negatives, concurrent start, churn, and idle/active 1/32/128 census                                                        | Strong for the bounded native generation-6 matrix           | Hostile writable-parent atomicity, fd/thread exhaustion injection, global quotas, and exited-Run GC are open          |
...
compile failures are reported as platform-impossible because generation 6
...
- **Earned streaming optimization:** freeze an incremental raw-byte consumer
  workload before changing generation-6 integer-array encoding. Adopt a new
