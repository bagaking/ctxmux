...
use ctxmux_protocol::{
    ...
    RUNTIME_CAPABILITY_TMUX_IMPORT, RunSignal, ServerFrame, StopDisposition,
};
use ts_rs::{Config, TS};
    ...
    fs::write(
        ...
        format!(
            concat!(
                ...
                "export const MAX_STOP_OPERATION_KEY_BYTES = {} as const;\n",
                "export const MAX_RUNTIME_BUILD_ID_BYTES = {} as const;\n",
                "export const MAX_RUNTIME_CAPABILITY_VERSION = {} as const;\n",
                "export const RUNTIME_CAPABILITY_NATIVE_START = {:?} as const;\n",
                "export const RUNTIME_CAPABILITY_NATIVE_RECOVERABLE_INPUT = {:?} as const;\n",
                "export const RUNTIME_CAPABILITY_NATIVE_RECOVERABLE_STOP = {:?} as const;\n",
                ...
                "export const REMOTE_ENDPOINT_CONTRACT_VERSION = {} as const;\n"
            ),
            PROTOCOL_VERSION,
            MAX_FRAME_BYTES,
